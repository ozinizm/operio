...
export default function DashboardPage() {
  ...
  const kpis = [
    ...
    { key: 'complaints_requests', title: 'Açık Şikayet/Talep', value: data?.open_complaints || 0, change: data?.critical_requests > 0 ? `${data.critical_requests} Kritik` : 'Normal', trend: data?.critical_requests > 0 ? 'down' : 'neutral', icon: AlertCircle, color: 'text-red-600', bg: 'bg-red-50/50', path: '/complaints' },
